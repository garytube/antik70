...
export const SITE = {
  ...
  DE: {
    ...
    LAMP_HEADLINE: 'Beleuchtung der besonderen Art\nVielfalt und Einzigartigkeit unsere Lampenwelt',
    LAMP_SUBLINE: 'Entdecken Sie bei uns ein umfangreiches Sortiment an alten und neuen Lampen, das keine Wünsche offen lässt. Von der zeitlosen Eleganz unserer Tiffany-Lampen bis hin zu unseren höhenverstellbaren Zug- und Pendelleuchten, Plafonieren, Wandlampen und edlen Tisch- und Stehleuchten aus Messing. Jede alte Lampe durchläuft eine Aufarbeitung, wird neu elektrifiziert und erfüllt höchste Sicherheitsstandards. Dazu kommt eine große Auswahl an alten und neuen Glasschirmen.',
