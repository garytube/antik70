...
<!-- <div class=" bg-redish-LIGHT z-50 w-full px-2 py-2.5 font-medium text-white">
	<div class="mx-auto text-center text-sm leading-relaxed sm:text-base">
		<span class="font-semibold">Betriebsferien:</span>
		<br />
		Antik70 macht vom <span class="font-bold text-yellow-200">14.07.2025</span> bis
		<span class="font-bold text-yellow-200">02.08.2025</span>
		Urlaub.<br />
...
<header class="relative my-8 flex px-6 lg:container lg:mt-16 lg:mb-8">
	<Logo />
	<Navigation />
</header>
